"""
Desenvolvimento um Cliente MCP conectnado em um servidor MCP localmente
(mesmo diretório) via protocolo STDIO com fastMCP
"""
from mcp import ClientSession, StdioServerParameters, types
from mcp.client.stdio import stdio_client
import asyncio # Permitir chamadas assíncronas
import traceback # Tratamento de erro
